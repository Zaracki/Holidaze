    ...
    <>
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
          ...
          <p className="text-white text-xl md:text-2xl max-w-[637px] mx-auto mb-6">
          ...
          <div className="flex items-center justify-center mt-5 w-full max-w-[660px]">
            <input
              ...
              className="flex-1 h-12 px-4 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <PrimaryButton className="h-12 w-[110px] ml-0">
              Search
            </PrimaryButton>
          </div>
        </div>
